 ...
 * @author Fancy.we
 */
@WebServlet(name = "SelectDeletedBlog", value = "/SelectDeletedBlog")
public class SelectDeletedBlog extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Blog> blogs = blogService.selectDeletedBlog(userId,page,size);
        for(Blog blog:blogs){
